  ...
  general: {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["一律優先使用最新上市藥品", "優先選用健保醫療常用第一線抗微生物製劑如Amoxicillin、Cephalexin等", "所有抗微生物製劑皆需事前審查", "只要病人要求即可使用後線藥品"],
        answer: 1,
      ...
      {
        q: "依通則，關於內服液劑的使用，下列哪些敘述正確？①12歲（含）以下兒童得使用。②不適合服用固型製劑者（如管灌飲食），得依病情需要使用。③非為兒童或吞嚥困難患者設計的內服液劑，得依病情需要使用。",
        options: ["僅①", "僅①②", "僅②③", "①②③皆正確"],
        answer: 3,
        explanation: "通則列明：12歲（含）以下兒童得使用內服液劑；不適合服用固型製劑者，以及非為兒童或吞嚥困難患者設計的內服液劑，均得依病情需要使用。"
      },
      {
      ...
      {
        q: "依通則，G-CSF（如 lenograstim）至多可攜回多少天？",
        options: ["3天", "6天", "14天", "30天"],
        answer: 1,
        explanation: "通則規定，G-CSF（如 filgrastim、lenograstim）至多攜回六天。"
      },
      {
        q: "依通則，處方用藥需符合哪項基本條件？",
      ...
      {
        q: "金屬瓣膜置換後的懷孕病患，依通則可攜回低分子量肝凝素注射劑自行注射，至多可攜回多久？",
        options: ["1週", "2週", "4週", "1個月"],
        answer: 1,
        explanation: "金屬瓣膜置換後之懷孕病患，可攜回低分子量肝凝素注射劑自行注射，但至多攜回兩週。"
      }
    ]
...
hormonal: {
  ...
  antimicrobial: {
    ...
    questions: [
      {
        q: "門診使用抗微生物製劑，原則上每次不得超過多少日份用量？",
        options: ["3日", "5日", "7日", "14日"],
        answer: 0,
        explanation: "門診使用抗微生物製劑以不超過3日份用量為原則；如有必要，每次以7日為限。"
      },
      {
        q: "慢性骨髓炎病人因病情需要延長抗微生物製劑給藥日數時，每次門診處方最長以多久為限？",
        options: ["3日", "7日", "2週", "4週"],
        answer: 2,
        explanation: "慢性骨髓炎病人得視病情需要延長給藥日數，但每次門診處方仍以2週為上限。"
      },
      {
        q: "使用幾種以上抗微生物製劑時，需附微生物培養及藥物敏感試驗報告？",
        options: ["1種以上", "2種以上", "3種以上", "4種以上"],
        answer: 2,
        explanation: "使用3種抗微生物製劑（含）以上，需附微生物培養及藥物敏感試驗報告。"
      },
      {
        q: "病人使用第一線抗微生物製劑超過多久，且培養及藥物敏感試驗證實具抗藥性時，得依規定改用第一線以外的抗微生物製劑？",
        options: ["24小時", "48小時", "72小時", "7日"],
        answer: 2,
        explanation: "使用第一線抗微生物製劑超過72小時，且培養及藥物敏感試驗證實對第一線製劑具抗藥性、確有需要時，得改用第一線以外製劑並檢附報告。"
      },
      {
        q: "清淨的甲類手術，預防性抗微生物製劑原則上應如何使用？",
        options: ["原則上免用；如需使用，可於術前給予一劑", "術前開始並持續3日", "術後固定使用7日", "一律使用第一線以外製劑"],
        answer: 0,
        explanation: "清淨的甲類手術原則上可免用抗微生物製劑；如需使用，可於術前給予一劑。手術超過2小時得於術中追加一劑，且限第一線製劑。"
      },
      {
        q: "Amoxicillin/clavulanic acid 用於符合規定的適應症時，得免附細菌敏感試驗報告，但療程以多久為限？",
        options: ["3日", "5日", "7日", "10日"],
        answer: 3,
        explanation: "用於急性化膿性中耳炎或鼻竇炎、急性下呼吸道感染、厭氧性細菌感染、菌血症等適應症時，得免附細菌敏感試驗報告，但以10日為限。"
      },
      {
        q: "關於抗疱疹病毒藥品的健保給付規定，下列何者正確？",
        options: ["Acyclovir口服劑與外用藥膏可以合併使用", "Famciclovir與Valaciclovir的一般療程以14日為限", "單純性疱疹於發病3日內，可使用Acyclovir藥膏，每次給藥量限5公克以內", "單純性疱疹使用Acyclovir藥膏時，每次最多可給予10公克"],
        answer: 2,
        explanation: "Acyclovir、Famciclovir及Valaciclovir除特別規定外，療程原則以10日為限；口服、注射劑及外用藥膏應擇一使用，不得合併。單純性疱疹於發病3日內，可使用Acyclovir或Tromantadine藥膏，每次給藥量限5公克以內。"
      },
      {
        q: "一般感染使用Azithromycin錠劑或膠囊劑時，正確的給付療程及每日最大劑量為何？",
        options: ["不超過3日，每日最大500 mg", "不超過5日，每日最大500 mg", "不超過7日，每日最大1,000 mg", "不超過10日，每日最大2,000 mg"],
        answer: 0,
        explanation: "Azithromycin錠劑或膠囊劑使用期間不得超過3日，每日最大劑量500 mg；MAC感染患者不受此限制。"
      },
      {
        q: "Clarithromycin用於消化性潰瘍的胃幽門桿菌消除治療時，使用期間不得超過多久？",
        options: ["3日", "7日", "10日", "14日"],
        answer: 3,
        explanation: "Clarithromycin用於消化性潰瘍的胃幽門桿菌消除治療，使用期間不得超過14日。"
      },
      {
        q: "Vancomycin口服製劑依健保給付規定，限用於下列何種疾病？",
        options: ["社區性肺炎", "複雜性泌尿道感染", "梭狀桿菌引起的假膜性結腸炎", "單純性皮膚感染"],
        answer: 2,
        explanation: "Vancomycin口服製劑限用於梭狀桿菌引起的假膜性結腸炎，且需符合規定的診斷方法並檢附相關報告。"
      }
    ]
  },
  immunologic: {
